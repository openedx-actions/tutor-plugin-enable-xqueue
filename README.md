...
[![Tests](https://github.com/openedx-actions/tutor-plugin-enable-xqueue/actions/workflows/testRelease.yml/badge.svg)](https://github.com/openedx-actions/tutor-plugin-enable-xqueue/actions)
  ...
  build:
    ...
    steps:
      ...
      - name: Enable tutor plugin - Xqueue
        uses: openedx-actions/tutor-enable-plugin-xqueue
        with:
          namespace: openedx-prod
